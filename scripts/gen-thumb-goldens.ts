// WOODFRAME-2 — rewrite the committed thumbnail goldens (plan §4.4, TD11/R4).
//
...
//
// The structural assertions in `test/woodframe2-thumbs.test.ts` (no external refs, no script,
