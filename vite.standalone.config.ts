...
// one <script src>. This config rebuilds the Survivability Positions tool alone into
// dist-standalone/ for inlining.
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      input: fileURLToPath(new URL('src/ui/survivability.html', import.meta.url)),
      output: {
