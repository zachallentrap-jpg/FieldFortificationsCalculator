...
/** The line every Woodframe card carries. Content, not chrome — it prints with the card. */
export const WOODFRAME_REGIME_LINE = '(PH) beside a citation means the manual page check is still pending.';
