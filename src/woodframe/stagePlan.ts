// WOODFRAME-2 — the stage model (plan §3.3, TD10).
//
 ...
 * one-story gable building's ordinals mean exactly what they meant in WOODFRAME-1 — the property
 * `test/woodframe2-stages.test.ts` asserts, and the reason the compat lock holds for free.
 */
