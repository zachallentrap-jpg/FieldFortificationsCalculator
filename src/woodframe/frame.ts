// WOODFRAME-1 engine — FrameModel assembly (design doc §1), now the WOODFRAME-2 compatibility port.
//
...
// `test/woodframe2-compat.test.ts` runs the demo building through it and asserts the result
