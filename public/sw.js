// 1371 service worker (§16). Cache-first with runtime caching so the app is fully offline
...
const CACHE = 'ce1371-v3';
const CORE = [
  './',
  './index.html',
  './survivability.html',
  './woodframe.html',
  './assets/survivability.js',
  './assets/survivability.css',
