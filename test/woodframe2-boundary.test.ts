...
//
//   1. A word-boundary lexicon over STRING LITERALS in src/woodframe and src/ui. Word boundaries,
...
import { COVER_DEPTH_NOTE, allDoctrineEntries } from '../src/woodframe/doctrine';
...
import { specToJson } from '../src/woodframe/normalize';
