...
import { normalizeSpec, canonicalizeSpec, specToJson, CLAMPED_PATHS } from '../src/woodframe/normalize';
import { SPEC_PATH_DEFS, SPEC_PATHS, WALL_ORDER, type BuildingSpec } from '../src/woodframe/spec';
