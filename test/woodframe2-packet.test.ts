...
import { packetHtml } from '../src/woodframe/packet/html';
import { honestyStrip, packetModel } from '../src/woodframe/packet/model';
import { LS_CONSUMERS, consumedLsIds } from '../src/woodframe/packet/lsgate';
import {
  CREW_MAX, CREW_MIN, DEFAULT_PRODUCTIVE_HOURS, HOURS_MAX, laborModel, maxUsefulCrew, timelineSvg,
} from '../src/woodframe/packet/labor';
import { APPROVAL_SCOPE, DECISION_LINE, LS_BANNER } from '../src/woodframe/packet/copy';
import { csvFilename, packetCsv } from '../src/woodframe/packet/csv';
import { lifeSafetyRegister, SPAN } from '../src/woodframe/doctrine';
import { familyById, shippedFamilies, type FamilyId } from '../src/woodframe/catalog';
import { generateStructure } from '../src/woodframe/families/index';
import { bomSummary } from '../src/woodframe/bom';
