...
import { CHOICE_COUNT, buildQuestion, isSelfGraded, pickMode, promptFor } from '../src/woodframe/train/drill';
import { WOODFRAME_REGIME_LINE } from '../src/woodframe/train/compile';
import { FUNDAMENTALS_ID, NAMING_ID, allDecks, fundamentalsDeck } from '../src/woodframe/train/decks';
...
import { shippedFamilies } from '../src/woodframe/catalog';
import { fmtFtIn } from '../src/woodframe/units';
...
} from '../src/woodframe/train/print';
...
test('every card in a real deck reaches the paper, front and back', () => {
  ...
  assert.ok(html.includes(WOODFRAME_REGIME_LINE), 'the (PH) line travels onto the paper');
