...
import { subtractCutouts, tileSurface, type Rect } from '../src/woodframe/subsystems/coverings';
import { generatePurlins, pyramidPlanes, planeSpanAt, roofPlanes } from '../src/woodframe/subsystems/roofFamilies';
import { familyById } from '../src/woodframe/catalog';
import { wallContract } from '../src/woodframe/subsystems/wallSystem';
import { specFromBuildingInput, type BuildingInput } from '../src/woodframe/frame';
import type { BuildingSpec, CoveringSpec } from '../src/woodframe/spec';
import { DRESSED } from '../src/woodframe/types';
import { LUMBER, ROOFING } from '../src/woodframe/doctrine';
import { rafterSeatLiftFt } from '../src/woodframe/birdsMouth';
